...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    ...
    date: "2026-03-13",
    changes: [
      "Painter: strip base64 image data from canvas serialization — prevents 400 'content too large' on save",
      "Execution errors: node snippet and toast now show the actual error message instead of 'Execution failed'",
    ],
  },
  {
    version: "0.27.9",
  ...
  },
  {
    ...
    date: "2026-03-11",
    changes: [
      "Fix: canvas auto-save no longer overwrites user-set document titles",
    ],
  },
  {
    version: "0.27.3",
  ...
  },
  {
    ...
    date: "2026-03-10",
    changes: [
      "Label nodes: settings gear button now appears on hover (font size, bold/italic, color)",
    ],
  },
  {
    version: "0.26.5",
    date: "2026-03-10",
    changes: [
      "Fix: canvas drag state no longer gets stuck after repeated node drags",
      "Root cause: useCallback closures captured stale dragState during React's deferred renders",
      "Solution: synchronous ref mirror (dragStateRef) ensures callbacks always read latest drag state",
    ],
  },
  {
    version: "0.26.4",
  ...
  },
  {
    ...
    date: "2026-03-10",
    changes: [
      "Fix CI test failure: align saveDocumentRequestSchema title max-length test with schema (500 chars, was 200)",
    ],
  },
  {
    version: "0.25.1",
  ...
  },
  {
    ...
    date: "2026-03-09",
    changes: [
      "Fix bug panel opening off-screen when status bar is at the bottom — dropdown now opens upward",
    ],
  },
  {
    version: "0.24.2",
    date: "2026-03-09",
    changes: [
      "Redirect provocations.replit.app to provocations.app with 301 permanent redirect",
    ],
  },
  {
    version: "0.24.1",
  ...
  },
  {
    ...
    date: "2026-03-09",
    changes: [
      "Fix AIQA overlay flying off-screen on infinite canvas — force all AIQA elements to fixed positioning with transform reset, add CSS containment to canvas root to prevent transform context leaking",
    ],
  },
  {
    version: "0.23.0",
  ...
  },
  {
    ...
    date: "2026-03-09",
    changes: [
      "Fix CSP blocking Clerk auth, AIQA widget, and BG Labs background — add missing domains to script-src, script-src-elem, connect-src, and frame-src",
    ],
  },
  {
    version: "0.22.2",
