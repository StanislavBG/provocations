  ...
  return (
    <>
      ...
      <AlertDialog open={showExitConfirm} onOpenChange={setShowExitConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Exit workflow?</AlertDialogTitle>
            <AlertDialogDescription>
              Your progress in the current session will be lost. Are you sure you want to exit?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={() => { setShowExitConfirm(false); exitWorkflow(); }}>
              Exit Workflow
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
