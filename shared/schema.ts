...
// ── Workspace Session State (for Save/Resume) ──────────────────────────

export const workspaceSessionStateSchema = z.object({
  document: z.object({ id: z.string(), rawText: z.string() }),
  objective: z.string(),
  secondaryObjective: z.string().optional(),
  interviewEntries: z.array(interviewEntrySchema),
  interviewDirection: z.object({
    mode: z.enum(directionModes),
    selectedPersonaIds: z.array(z.string()),
    guidance: z.string(),
  }),
  isInterviewActive: z.boolean().optional(),
  currentInterviewQuestion: z.string().nullable().optional(),
  currentInterviewTopic: z.string().nullable().optional(),
...
export const updateSessionRequestSchema = z.object({
  ...
  state: workspaceSessionStateSchema.optional(),
});
